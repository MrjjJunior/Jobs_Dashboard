...
export const PrivacyPolicy: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  return (
    <div className="min-h-screen bg-[#F3E8EE] p-6 lg:p-12 font-sans text-pine-900">
      <button onClick={onBack} className="flex items-center gap-2 text-[#003B36] font-bold mb-8 hover:underline">
        <ArrowLeft className="w-4 h-4" /> Back to Home
      </button>
      <div className="max-w-3xl mx-auto bg-white p-8 sm:p-12 rounded-2xl shadow-sm border border-linen-200">
        <h1 className="text-3xl font-extrabold text-[#003B36] mb-6">Privacy Policy</h1>
        <p className="text-sm text-[#917C78] mb-6">Last updated: September 2026</p>
        
        <div className="space-y-6 text-sm text-[#003B36] leading-relaxed">
          <section>
            <h2 className="text-lg font-bold text-[#003B36] mb-2">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#003B36] mb-2">2. Data We Collect</h2>
            <p>We may collect, use, store and transfer different kinds of personal data about you which we have grouped together follows:</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li><strong>Identity Data:</strong> includes first name, last name, username or similar identifier.</li>
              <li><strong>Contact Data:</strong> includes email address and telephone numbers.</li>
              <li><strong>Career Data:</strong> includes your resumes, job applications, interview notes, and target goals.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[#003B36] mb-2">3. Local-First Storage</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#003B36] mb-2">4. AI Processing</h2>
