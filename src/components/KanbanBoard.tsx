            ...
            <div className="flex-1 overflow-y-auto space-y-3 pr-1">
              {stageJobs.length === 0 ? (
                <button
                  type="button"
                  onClick={() => onAddNewInStage(stageKey)}
                  className="w-full p-5 text-center border-2 border-dashed border-slate-200 hover:border-emerald-500 bg-white/60 hover:bg-emerald-50/50 rounded-xl flex flex-col items-center justify-center gap-2 transition-all duration-150 group cursor-pointer focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:outline-hidden"
                >
                  <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-emerald-100 text-slate-400 group-hover:text-emerald-600 flex items-center justify-center transition-colors">
                    <Plus className="w-4 h-4" />
                  </div>
                  <div>
                    <p className="text-xs font-semibold text-slate-700 group-hover:text-emerald-800 transition-colors">
                      Add Application
                    </p>
                    <p className="text-[11px] text-slate-400 group-hover:text-emerald-600/80 transition-colors">
                ...
                <>
                  ...
                  <button
                    type="button"
                    onClick={() => onAddNewInStage(stageKey)}
                    className="w-full py-2.5 px-3 border border-dashed border-slate-200 hover:border-emerald-400 bg-white/50 hover:bg-emerald-50/40 text-slate-500 hover:text-emerald-700 rounded-xl flex items-center justify-center gap-1.5 text-xs font-semibold transition-all duration-150 group cursor-pointer shadow-2xs hover:shadow-xs focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:outline-hidden"
                  >
