  ...
  return (
    <div className="min-h-screen bg-[#F3E8EE] p-6 lg:p-12 font-sans text-pine-900">
      ...
      <div className="max-w-3xl mx-auto bg-white p-8 sm:p-12 rounded-2xl shadow-sm border border-linen-200">
        <h1 className="text-3xl font-extrabold text-[#003B36] mb-6">Terms of Service</h1>
        ...
        <div className="space-y-6 text-sm text-[#003B36] leading-relaxed">
          <section>
            <h2 className="text-lg font-bold text-[#003B36] mb-2">1. Agreement to Terms</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#003B36] mb-2">2. Use License</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#003B36] mb-2">3. Disclaimer</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#003B36] mb-2">4. User Account and Data</h2>
